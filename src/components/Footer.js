  ...
  return (
    <footer className="bg-primary text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm mb-4">
              Subscribe to receive updates and inspiration.
            </p>
            <form className="flex flex-col space-y-2">
              ...
              <button
                type="submit"
                className="bg-secondary hover:bg-accent text-white px-4 py-2 rounded transition-colors duration-200"
              >
                Subscribe
              </button>
            </form>
        ...
        {/* Copyright */}
        <div className="mt-8 pt-4 border-t border-secondary text-center text-gray-300 text-sm">
          <p>&copy; {new Date().getFullYear()} Glad Tidings. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
